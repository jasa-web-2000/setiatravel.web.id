        ...
        <div class="grid place-items-center">
          <a href="<?= $domain ?>">
            <img
              ...
              class="w-14 md:w-20 xl:w-24 m-auto rounded"
              alt="logo" />
          </a>
        </div>
  ...
  <main class="overflow-x-hidden">
    ...
    <section class="container">
      <div
        ...
        <div
          ...
          <div class="md:!col-span-5 p-5 md:p-10 md:-top-10 lg:p-20 z-10 !scroll-mt-24" id="pesan-online">
            <div
    ...
    <!-- <section class="container my-20">
      <a href="<?= $link_whatsapp ?>" target="_blank">
        <img class="w-full h-auto rounded shadow-lg" src="<?= $domain ?>src/img/baner.jpeg" alt="Baner Tikfa Travels Makassar">
      </a>
    </section> -->
    <!-- Baner -->

    <!-- Rute Travel -->
    <section class="container my-20 !scroll-mt-24" id="rute-travel">
      <div class="">
    ...
    <!-- Tentang Kami -->
    <section id="tentang-kami" class="bg-gradient-to-tr from-primary to-primary-hover py-20 !scroll-mt-24">
      <div class="container">
        ...
        <div
          ...
          <div class="max-w-2xl mx-auto">
            <h2 class="text-white text-4xl">
              Apakah anda ingin perjalanan travel Makassar yang aman dan cepat?
            </h2>
            <p
          ...
          <div
            ...
            <a
              href="#rute-travel"
              class="flex gap-2 px-5 py-2 border-2 border-slate-200 hover:border-primary-hover bg-transparent hover:bg-primary-hover text-slate-200 hover:text-slate-200 rounded-lg w-min top-0 hover:top-2 transition-all duration-700 relative !scroll-mt-24">
              Rute
            </a>
          </div>
          <ul
    ...
    <!-- Galeri -->
    <section class="bg-blue-50 my-20 py-20 !scroll-mt-24"
      id="galeri">
      <div class=" container">
        <div class="">
          <div class="text-center inner-container">
    ...
    <!-- Kontak -->
    <section class="bg-blue-50 mt-20 py-20 !scroll-mt-24"
      id="kontak">
      <div class="container">
        <div class="">
          <div class="text-center inner-container">
